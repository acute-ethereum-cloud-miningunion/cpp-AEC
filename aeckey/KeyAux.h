...
#include <libaeccore/TransactionBase.h>
...
//			<< "    exportbare [ <uuid> , ... ]  Export given keys." << endl
			...
			<< "    createwallet  Create an aecmio master wallet." << endl
...
//			<< "    recode [ <address>|<uuid>|<file> , ... ]  Decrypt and re-encrypt given keys." << endl
			...
			<< "    --wallet-path <path>  Specify aecmio wallet path (default: " << KeyManager::defaultPath() << ")" << endl
