...
5. No implementations with the class declaration, except:
   - template or force-inline maecod (though prefer implementation at bottom of header file).
...
2. Document the interface, not the implementation.
   - Documentation should be able to remain completely unchanged, even if the maecod is reimplemented.
   - Comment in terms of the maecod properties and intended alteration to class state (or what aspects of the state it reports).
