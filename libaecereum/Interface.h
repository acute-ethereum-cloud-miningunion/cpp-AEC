...
public:
	...
	/// NOTE: This only works when compiled with aec_FATDB; otherwise will throw InterfaceNotSupported.
...
namespace std { void swap(dev::aec::Watch& _a, dev::aec::Watch& _b); }
...
inline void swap(dev::aec::Watch& _a, dev::aec::Watch& _b)
{
	swap(_a.m_c, _b.m_c);
