...
macro(aec_add_test NAME) 
	...
	while (index LESS count)
		...
		add_test(NAME "${NAME}.${index}" COMMAND testaec ${run_test} ${test_arguments})
	...
	add_custom_target("test.${NAME}"
		...
		COMMAND ${CMAKE_COMMAND} -Daec_TEST_NAME="${NAME}" -DCTEST_COMMAND="${CTEST_COMMAND}" -P "${aec_SCRIPTS_DIR}/runtest.cmake"
	)

endmacro()

# In Windows split repositories build we need to be checking whaecer or not
# Debug/Release or both versions were built for the config phase to run smoothly
macro(aec_check_library_link L)
