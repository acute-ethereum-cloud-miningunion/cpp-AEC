#------------------------------------------------------------------------------
# aecCompilerSettings.cmake
#
# CMake file for cpp-aecmio project which specifies our compiler settings
# for each supported platform and build configuration.
#
# The documentation for cpp-aecmio is hosted at http://cpp-aecmio.org
#
# Copyright (c) 2014-2016 cpp-aecmio contributors.
#------------------------------------------------------------------------------
...
include(aecCheckCXXCompilerFlag)

aec_add_cxx_compiler_flag_if_supported(-fstack-protector-strong have_stack_protector_strong_support)
if(NOT have_stack_protector_strong_support)
	aec_add_cxx_compiler_flag_if_supported(-fstack-protector)
endif()

aec_add_cxx_compiler_flag_if_supported(-Wimplicit-fallthrough)
...
if (("${CMAKE_CXX_COMPILER_ID}" MATCHES "GNU") OR ("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang"))
	...
	set(CMAKE_CXX_FLAGS_DEBUG          "-Og -g -Daec_DEBUG")
