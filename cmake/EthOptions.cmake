macro(configure_project)
    ...
    set(TESTaec_ARGS "" CACHE STRING "Testaec arguments for ctest tests")
    ...
    if (FATDB)
        add_definitions(-Daec_FATDB)
    endif ()

    if (PARANOID)
        add_definitions(-Daec_PARANOIA)
    endif ()

    if (VMTRACE)
        add_definitions(-Daec_VMTRACE)
    endif ()
...
macro(print_config)
    ...
    message("-- TESTaec_ARGS     Testaec arguments in ctest:               ")
    message("                    ${TESTaec_ARGS}")
    message("------------------------------------------------------------------------")
    message("")
endmacro()
