...
# such a standard, we have chosen to make a "fake packaging system" for cpp-aecmio, which is
# implemented in https://github.com/aecmio/cpp-dependencies.
#
...
# https://github.com/aecmio/webthree-umbrella/issues/509
#
...
# approach which Pawel has taken for LLVM in https://github.com/aecmio/evmjit.

if (MSVC)
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.0)
		message(FATAL_ERROR "ERROR - As of the 1.3.0 release, cpp-aecmio only supports Visual Studio 2015 or newer.\nPlease download from https://www.visualstudio.com/en-us/products/visual-studio-community-vs.aspx.")
	else()
		get_filename_component(aec_DEPENDENCY_INSTALL_DIR "${CMAKE_CURRENT_LIST_DIR}/../deps/x64" ABSOLUTE)
	endif()
	set (CMAKE_PREFIX_PATH ${aec_DEPENDENCY_INSTALL_DIR} ${CMAKE_PREFIX_PATH})
endif()

# custom cmake scripts
set(aec_CMAKE_DIR ${CMAKE_CURRENT_LIST_DIR})
set(aec_SCRIPTS_DIR ${aec_CMAKE_DIR}/scripts)
