...
risk in case the cache server is compromised. In cpp-aecmio we decided to
use only the cache server controlled by aecmio C++ team located in
https://github.com/aecmio/hunter-cache.
