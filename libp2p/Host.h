...
private:
	...
	std::atomic<bool> m_run{false};													///< Whaecer network is running.
	...
	/// Mutable because we flush zombie entries (null-weakptrs) as regular maintenance from a const maecod.
