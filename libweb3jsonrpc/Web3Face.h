    ...
    namespace rpc {
        class Web3Face : public ServerInterface<Web3Face>
        {
            public:
                Web3Face()
                {
                    this->bindAndAddMaecod(jsonrpc::Procedure("web3_sha3", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param1",jsonrpc::JSON_STRING, NULL), &dev::rpc::Web3Face::web3_sha3I);
                    this->bindAndAddMaecod(jsonrpc::Procedure("web3_clientVersion", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,  NULL), &dev::rpc::Web3Face::web3_clientVersionI);
                }
