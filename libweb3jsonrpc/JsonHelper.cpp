...
#include <libaeccore/SealEngine.h>
...
Json::Value toJson(dev::aec::BlockHeader const& _bi, SealEngineFace* _sealer)
{
    Json::Value res;
    if (_bi)
    {
...
Json::Value toJson(dev::aec::Transaction const& _t, std::pair<h256, unsigned> _location, BlockNumber _blockNumber)
{
    Json::Value res;
    if (_t)
    {
...
Json::Value toJson(dev::aec::BlockHeader const& _bi, BlockDetails const& _bd, UncleHashes const& _us, Transactions const& _ts, SealEngineFace* _face)
{
...
Json::Value toJson(dev::aec::BlockHeader const& _bi, BlockDetails const& _bd, UncleHashes const& _us, TransactionHashes const& _ts, SealEngineFace* _face)
{
    Json::Value res = toJson(_bi, _face);
    if (_bi)
    {
...
Json::Value toJson(dev::aec::TransactionSkeleton const& _t)
{
    Json::Value res;
...
Json::Value toJson(dev::aec::TransactionReceipt const& _t)
{
    Json::Value res;
    if (_t.hasStatusCode())
...
Json::Value toJson(dev::aec::LocalisedTransactionReceipt const& _t)
{
    Json::Value res;
...
Json::Value toJson(dev::aec::Transaction const& _t)
{
    Json::Value res;
...
Json::Value toJson(dev::aec::LocalisedTransaction const& _t)
{
    Json::Value res;
    if (_t)
    {
...
Json::Value toJson(dev::aec::LocalisedLogEntry const& _e)
{
    Json::Value res;
    ...
    {
        res = toJson(static_cast<dev::aec::LogEntry const&>(_e));
...
Json::Value toJson(dev::aec::LogEntry const& _e)
{
    Json::Value res;
...
Json::Value toJson(std::unordered_map<h256, dev::aec::LocalisedLogEntries> const& _entriesByBlock, vector<h256> const& _order)
{
...
Json::Value toJsonByBlock(LocalisedLogEntries const& _entries)
{
    ...
    for (dev::aec::LocalisedLogEntry const& e: _entries)
    {
...
TransactionSkeleton toTransactionSkeleton(Json::Value const& _json)
{
    ...
    if (!_json["data"].empty())							// aecmio.js has preconstructed the data array
...
dev::aec::LogFilter toLogFilter(Json::Value const& _json)
{
    dev::aec::LogFilter filter;
    if (!_json.isObject() || _json.empty())
        return filter;
...
dev::aec::LogFilter toLogFilter(Json::Value const& _json, Interface const& _client)	// commented to avoid warning. Uncomment once in use @ PoC-7.
{
    dev::aec::LogFilter filter;
    if (!_json.isObject() || _json.empty())
        return filter;
