...
TransactionNotification SimpleAccountHolder::authenticate(dev::aec::TransactionSkeleton const& _t)
{
...
TransactionNotification FixedAccountHolder::authenticate(dev::aec::TransactionSkeleton const& _t)
{
	TransactionNotification ret;
	if (isRealAccount(_t.from))
	{
