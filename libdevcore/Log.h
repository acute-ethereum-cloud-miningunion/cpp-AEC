...
{
    _strm.stream() << aecNavy << _value << aecReset;
    return _strm;
}
inline boost::log::formatting_ostream& operator<<(
...
{
    _strm.stream() << aecTeal "#" << _value.abridged() << aecReset;
    return _strm;
}
template <unsigned N>
inline boost::log::formatting_ostream& operator<<(
...
{
    _strm.stream() << aecRed "@" << _value.abridged() << aecReset;
    return _strm;
}
inline boost::log::formatting_ostream& operator<<(
...
{
    _strm.stream() << aecCyan "#" << _value.abridged() << aecReset;
    return _strm;
}
inline boost::log::formatting_ostream& operator<<(
...
{
    _strm.stream() << aecYellow "%" << toHex(_value) << aecReset;
    return _strm;
}
}  // namespace dev
...
{
    _strm.stream() << aecYellow "%" << dev::toHex(_value) << aecReset;
    return _strm;
}
inline boost::log::formatting_ostream& operator<<(
...
{
    _strm.stream() << aecWhite "[" aecReset;
    int n = 0;
    for (T const& i : _value)
    {
        _strm.stream() << (n++ ? aecWhite ", " aecReset : "");
        _strm << i;
    }
    _strm.stream() << aecWhite "]" aecReset;
    return _strm;
...
{
    _strm.stream() << aecYellow "{" aecReset;
    int n = 0;
    for (T const& i : _value)
    {
        _strm.stream() << (n++ ? aecYellow ", " aecReset : "");
        _strm << i;
    }
    _strm.stream() << aecYellow "}" aecReset;
    return _strm;
...
{
    _strm.stream() << aecLime "{" aecReset;
    int n = 0;
    for (auto const& i : _value)
    {
        _strm << (n++ ? aecLime ", " aecReset : "");
        _strm << i.first;
        _strm << (n++ ? aecLime ": " aecReset : "");
        _strm << i.second;
    }
...
{
    _strm << aecLime "{" aecReset;
    int n = 0;
    for (auto const& i : _value)
    {
        _strm.stream() << (n++ ? aecLime ", " aecReset : "");
        _strm << i.first;
        _strm.stream() << (n++ ? aecLime ": " aecReset : "");
        _strm << i.second;
    }
...
{
    _strm.stream() << aecPurple "(" aecReset;
    _strm << _value.first;
    _strm.stream() << aecPurple ", " aecReset;
    _strm << _value.second;
    _strm.stream() << aecPurple ")" aecReset;
