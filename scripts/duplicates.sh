...
#------------------------------------------------------------------------------
# Python script to analysis cpp-aecmio commits, and filter out duplicates
#
...
authorAliases['chrisaec'] = 'Christian Reitwiessner'
