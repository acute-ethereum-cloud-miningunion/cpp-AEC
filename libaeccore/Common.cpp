...
{
	string const c_line = aecReset aecOnMaroon + string(80, ' ') + aecReset;
	string const c_border = aecReset aecOnMaroon + string(2, ' ') + aecReset aecMaroonBold;
	string const c_space = c_border + string(76, ' ') + c_border + aecReset;
	stringstream ss;
	ss << c_line << "\n";
	ss << c_space << "\n";
