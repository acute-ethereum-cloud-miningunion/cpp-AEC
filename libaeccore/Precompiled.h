...
public:
	...
	/// Register an executor. In general just use aec_REGISTER_PRECOMPILED.
	...
	/// Register a pricer. In general just use aec_REGISTER_PRECOMPILED_PRICER.
...
#define aec_REGISTER_PRECOMPILED(Name) static std::pair<bool, bytes> __aec_registerPrecompiledFunction ## Name(bytesConstRef _in); static PrecompiledExecutor __aec_registerPrecompiledFactory ## Name = ::dev::aec::PrecompiledRegistrar::registerExecutor(#Name, &__aec_registerPrecompiledFunction ## Name); static std::pair<bool, bytes> __aec_registerPrecompiledFunction ## Name
#define aec_REGISTER_PRECOMPILED_PRICER(Name) static bigint __aec_registerPricerFunction ## Name(bytesConstRef _in); static PrecompiledPricer __aec_registerPricerFactory ## Name = ::dev::aec::PrecompiledRegistrar::registerPricer(#Name, &__aec_registerPricerFunction ## Name); static bigint __aec_registerPricerFunction ## Name
}
}
