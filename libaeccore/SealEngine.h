...
#define aec_REGISTER_SEAL_ENGINE(Name) static SealEngineFactory __aec_registerSealEngineFactory ## Name = SealEngineRegistrar::registerSealEngine<Name>(#Name)

class NoProof: public aec::SealEngineBase
{
public:
