...
#include <libaecashseal/aecashCPUMiner.h>
...
void connectClients(Client& c1, Client& c2)
{
    (void)c1;
    (void)c2;
// TODO: Move to WebThree. aec::Client no longer handles networking.
#if 0
	short c1Port = 20000;
	short c2Port = 21000;
...
{
    aecashCPUMiner::setNumInstances(1);
...
void mine(BlockHeader& _bi, SealEngineFace* _sealer, bool _verify)
{
    ...
    //	cdebug << "Block mined" << aecash::boundary(_bi).hex() <<
    // aecash::nonce(_bi) << _bi.hash(WithoutSeal).hex();
...
string netIdToString(aec::Network _netId)
{
    switch (_netId)
    {
    case aec::Network::FrontierTest:
        return "Frontier";
    case aec::Network::HomesteadTest:
        return "Homestead";
    case aec::Network::EIP150Test:
        return "EIP150";
    case aec::Network::EIP158Test:
        return "EIP158";
    case aec::Network::ByzantiumTest:
        return "Byzantium";
    case aec::Network::ConstantinopleTest:
        return "Constantinople";
    case aec::Network::FrontierToHomesteadAt5:
        return "FrontierToHomesteadAt5";
    case aec::Network::HomesteadToDaoAt5:
        return "HomesteadToDaoAt5";
    case aec::Network::HomesteadToEIP150At5:
        return "HomesteadToEIP150At5";
    case aec::Network::EIP158ToByzantiumAt5:
        return "EIP158ToByzantiumAt5";
    case aec::Network::TransitionnetTest:
...
aec::Network stringToNetId(string const& _netname)
{
    // Networks that used in .json tests
    static vector<aec::Network> const networks{
        {aec::Network::FrontierTest, aec::Network::HomesteadTest, aec::Network::EIP150Test,
            aec::Network::EIP158Test, aec::Network::ByzantiumTest, aec::Network::ConstantinopleTest,
            aec::Network::FrontierToHomesteadAt5, aec::Network::HomesteadToDaoAt5,
            aec::Network::HomesteadToEIP150At5, aec::Network::EIP158ToByzantiumAt5,
            aec::Network::TransitionnetTest}};
    ...
    return aec::Network::FrontierTest;
}

bool isDisabledNetwork(aec::Network _net)
{
...
set<aec::Network> const& getNetworks()
{
    // Networks for the test case execution when filling the tests
    static set<aec::Network> const networks{{aec::Network::FrontierTest,
        aec::Network::HomesteadTest, aec::Network::EIP150Test, aec::Network::EIP158Test,
        aec::Network::ByzantiumTest, aec::Network::ConstantinopleTest}};
    return networks;
}
...
string exportLog(aec::LogEntries const& _logs)
{
    RLPStream s;
...
void checkCallCreates(
    aec::Transactions const& _resultCallCreates, aec::Transactions const& _expectedCallCreates)
{
...
{
    return string{"testaec "} + alaec_get_buildinfo()->project_version;
}
...
dev::aec::BlockHeader constructHeader(h256 const& _parentHash, h256 const& _sha3Uncles,
    Address const& _author, h256 const& _stateRoot, h256 const& _transactionsRoot,
    h256 const& _receiptsRoot, dev::aec::LogBloom const& _logBloom, u256 const& _difficulty,
    ...
    bytes const& _extraData)
{
    ...
    rlpStream << _parentHash << _sha3Uncles << _author << _stateRoot << _transactionsRoot
              ...
              << _timestamp << _extraData << h256{} << aec::Nonce{};

    return BlockHeader(rlpStream.out(), HeaderData);
}

void updateaecashSeal(dev::aec::BlockHeader& _header, h256 const& _mixHash, h64 const& _nonce)
{
    aecash::setNonce(_header, _nonce);
    aecash::setMixHash(_header, _mixHash);
}
