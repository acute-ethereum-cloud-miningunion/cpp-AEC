...
#
#     make -f tests.mk SOLC=solc aecVM=aecvm EVM=evm PARITY=parity-evm all
#
# or build and run only a single test on a single VM
#
#     make -f tests.mk SOLC=solc aecVM=aecvm pop.ran
#
...
#
#     make -f tests.mk SOLC=solc aecVM=../../../build/aecvm/aecvm all
...
ifdef aecVM
	aecVM_ = $(call STATS,aecvm) $(aecVM) $*.bin test; touch $*.ran
endif
ifdef EVM
