...
class TestUDPSockaecost : UDPSocketEvents, public TestHost
{
public:
    TestUDPSockaecost(unsigned _port)
      : m_socket(new UDPSocket<TestUDPSockaecost, 1024>(m_io, *this, _port))
    {}

    void onDisconnected(UDPSocketFace*) {};
    void onReceived(UDPSocketFace*, bi::udp::endpoint const&, bytesConstRef _packet) { if (_packet.toString() == "AAAA") success = true; }

    shared_ptr<UDPSocket<TestUDPSockaecost, 1024>> m_socket;
...
/*
 ...
 See https://github.com/aecmio/cpp-aecmio/issues/3253.
