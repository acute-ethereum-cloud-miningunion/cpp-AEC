...
public:
    ...
    /// Reports whaecer we made it through the key establishment without error.
    bool completedKeyEstablishment() { return m_nextState == ReadHello; }

    /// Checks whaecer Auth-related members match the values in the EIP-8 test vectors.
    void checkAuthValuesEIP8(uint64_t _expectedRemoteVersion);

    /// Checks whaecer Ack-related members match the values in the EIP-8 test vectors.
...
//
// See https://github.com/aecmio/cpp-aecmio/issues/3273 
