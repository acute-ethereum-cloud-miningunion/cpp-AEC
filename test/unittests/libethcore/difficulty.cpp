...
void fillDifficulty(boost::filesystem::path const& _testFileFullName, aecash& _sealEngine)
{
	int testN = 0;
...
void testDifficulty(fs::path const& _testFileFullName, aecash& _sealEngine)
{
	//Test File
	js::mValue v;
...
BOOST_AUTO_TEST_CASE(difficultyTestsFrontier)
{
	...
	aecash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aec::Network::FrontierTest)));
...
BOOST_AUTO_TEST_CASE(difficultyTestsRopsten)
{
	...
	aecash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aec::Network::Ropsten)));
...
BOOST_AUTO_TEST_CASE(difficultyTestsHomestead)
{
	...
	aecash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aec::Network::HomesteadTest)));
...
BOOST_AUTO_TEST_CASE(difficultyByzantium)
{
	...
	aecash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aec::Network::ByzantiumTest)));
...
BOOST_AUTO_TEST_CASE(difficultyTestsMainNetwork)
{
	...
	aecash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aec::Network::MainNetworkTest)));
...
BOOST_AUTO_TEST_CASE(basicDifficultyTest)
{
	...
	aecash sealEngine;
	sealEngine.setChainParams(ChainParams(genesisInfo(aec::Network::MainNetwork)));
