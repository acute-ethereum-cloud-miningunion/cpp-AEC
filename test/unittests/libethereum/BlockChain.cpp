 ...
 * @author Dimitry Khokhlov <dimitry@aecdev.com>
 * @date 2015
...
BOOST_AUTO_TEST_CASE(opendb)
{
    ...
    ChainParams p(genesisInfo(aec::Network::TransitionnetTest), genesis.bytes(), genesis.accountMap());
...
See https://github.com/aecmio/cpp-aecmio/issues/3256.
...
See https://github.com/aecmio/cpp-aecmio/issues/3059.
